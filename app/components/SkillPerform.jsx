...
export default function SkillPerform() {
  const data = {
    categories: [
        {
            ...
            "questions": [
              ...
              {
                "question": "What does the 'transform' property in CSS allow you to do?",
                "options": [
              ...
              {
                "question": "In JavaScript, what is a 'closure' and how is it useful?",
                "options": [
                ...
                "answer": "A function that retains access to its outer function's scope"
              },
              {
              ...
              },
              {
                ...
                "answer": "An object representing a value that might be available in the future"
              },
              {
                "question": "In CSS Grid, what does the 'grid-template-areas' property allow you to do?",
                "options": [
              ...
              },
              {
                ...
                "answer": "A way to cache and reuse the results of expensive function calls"
              },
              {
                "question": "What is the role of 'redux-saga' in React applications?",
                "options": [
                ...
                "answer": "A middleware for managing side effects like asynchronous actions"
              }
            ]
          },
          {
            ...
            "questions": [
              {
                "question": "What is the primary purpose of a backend in web development?",
                "options": [
              ...
              {
                "question": "In backend development, what does 'Node.js' primarily enable you to do?",
                "options": [
              ...
              {
                "question": "What is the purpose of 'API Design and RESTful Architecture'?",
                "options": [
              ...
              {
                "question": "Why is 'Authentication and Authorization' important in backend development?",
                "options": [
              ...
              {
                "question": "What is the purpose of 'Server Deployment and Hosting'?",
                "options": [
              ...
              {
                "question": "What is the purpose of 'Load Balancing' in backend server architecture?",
                "options": [
              ...
              },
              {
                ...
                "answer": "A layer of code that sits between the frontend and backend"
              },
              {
          ...
          },
          {
            ...
            "questions": [
              {
                "question": "What is the role of a 'Full Stack Developer' in web development?",
                "options": [
                ...
                "answer": "Working on both frontend and backend aspects of applications"
              },
              {
                "question": "What does 'Combining Frontend and Backend Skills' involve?",
                "options": [
                ...
                "answer": "Applying both client-side and server-side development knowledge"
              },
              {
                "question": "In 'Building Full Stack Applications', what is the significance of 'MVC' architecture?",
                "options": [
                ...
                "answer": "Separating application logic into Model, View, and Controller components"
              },
              {
                "question": "When 'Working with Different Databases', what is an advantage of using a NoSQL database over a traditional SQL database?",
                "options": [
              ...
              {
                "question": "What is the primary purpose of 'Version Control and Collaboration' tools in full stack development?",
                "options": [
                  "Optimizing frontend rendering",
                  "Managing database queries",
                ...
                "answer": "Tracking changes to code and collaborating with team members"
              },
              {
                "question": "In 'Understanding Client-Server Interaction', what role does an 'API' play?",
                "options": [
                  "Optimizing frontend performance",
                ...
                "answer": "Defining communication protocols between clients and servers"
              },
              {
                "question": "When 'Building Full Stack Applications', what is the purpose of 'dependency injection'?",
                "options": [
                  "Optimizing frontend code",
                ...
                "answer": "Passing dependencies to components for better modularity"
              },
              {
                "question": "In 'Working with Different Databases', what is a 'migration'?",
                "options": [
                ...
                "answer": "A script that automates the creation and modification of database schema"
              },
              {
                "question": "What is the purpose of 'WebSockets' in 'Understanding Client-Server Interaction'?",
                "options": [
              ...
              {
                "question": "When 'Building Full Stack Applications', what is the significance of 'Containerization'?",
                "options": [
                ...
                "answer": "Isolating applications in lightweight, portable environments"
              }
            ]
          },
          {
            ...
            "questions": [
              {
                "question": "In Android development, what is the purpose of 'Activities'?",
                "options": [
              ...
              {
                "question": "What programming languages are commonly used for Android app development?",
                "options": [
              ...
              {
                "question": "In Android, what is the primary purpose of 'Services'?",
                "options": [
              ...
              {
                "question": "What is the 'Google Play Store' used for in Android development?",
                "options": [
          ...
          },
          {
            ...
            "questions": [
              {
                "question": "What is the underlying technology behind blockchain that ensures data immutability?",
                "options": [
              ...
              },
              {
                ...
                "answer": "A self-executing contract with predefined rules and actions"
              },
              {
                "question": "What programming language is commonly used for writing 'Smart Contracts' on the Ethereum blockchain?",
                "options": [
                  "JavaScript",
                  "Python",
                  "Solidity",
              ...
              {
                "question": "What are 'Decentralized Applications (DApps)' in blockchain development?",
                "options": [
                ...
                "answer": "Apps that run on a blockchain network with no central control"
              },
              {
              ...
              },
              {
                ...
                "answer": "Combining blockchain with traditional centralized databases"
              },
              {
                ...
                "answer": "A method for achieving agreement on the state of the blockchain"
              },
              {
              ...
              },
              {
                ...
                "answer": "Private blockchains are controlled by a central authority, while public blockchains are decentralized"
              }
            ]
          },
          {
            ...
            "questions": [
              {
                ...
                "answer": "Improving collaboration between development and operations teams"
              },
              {
              ...
              {
                "question": "What is the purpose of 'Containerization' in DevOps using tools like Docker?",
                "options": [
                  "Managing user authentication",
                ...
                "answer": "Isolating and packaging applications with their dependencies"
              },
              {
              ...
              {
                "question": "What is the primary advantage of using 'Infrastructure as Code' (IaC) tools?",
                "options": [
              ...
              },
              {
                ...
                "answer": "Deploying new application versions alongside the existing version"
              },
              {
                "question": "In DevOps, what is the main benefit of 'Continuous Monitoring'?",
                "options": [
                  "Optimizing frontend performance",
              ...
              {
                "question": "What is the concept of 'Infrastructure as Code' (IaC) commonly associated with?",
                "options": [
                  "Creating dynamic UI components",
          ...
          },
          {
            ...
            "questions": [
              {
                "question": "In data structures, what is the primary purpose of 'Arrays'?",
                "options": [
              ...
              {
                "question": "What do 'Trees' and 'Graphs' represent in data structures?",
                "options": [
              ...
              {
                "question": "What is the primary purpose of 'Hashing and Hash Tables'?",
                "options": [
              ...
              {
                "question": "Which algorithm rearranges elements in a particular order, often in ascending or descending?",
                "options": [
                  "Sorting Algorithm",
                  "Searching Algorithm",
                  "Hashing Algorithm",
              ...
              {
                "question": "What is the purpose of 'Complexity Analysis' in data structures and algorithms?",
                "options": [
              ...
              },
              {
                ...
                "answer": "A linear data structure consisting of nodes connected by pointers"
              },
              {
          ...
          },
          {
            ...
            "questions": [
              ...
              {
                "question": "What is the primary concept behind 'Machine Learning'?",
                "options": [
              ...
              {
                "question": "What is the purpose of 'Deep Learning and Neural Networks'?",
                "options": [
              ...
              {
                "question": "Which AI subfield focuses on enabling machines to understand, interpret, and generate human language?",
                "options": [
                  "Robotics",
              ...
              {
                "question": "What is the role of 'AI Ethics and Bias' in artificial intelligence development?",
                "options": [
              ...
              {
                "question": "What is the process of making AI models available for use by other applications?",
                "options": [
                  "AI Code Generation",
              ...
              {
                "question": "Which AI technique is used for training models to improve their performance over time without explicit programming?",
                "options": [
                  "Supervised Learning",
              ...
              {
                "question": "What does 'Neural Network Activation Function' determine in deep learning?",
                "options": [
              ...
              {
                "question": "What is the goal of 'Transfer Learning' in machine learning?",
                "options": [
                ...
                "answer": "Adapting knowledge from one task to improve learning on another task"
              },
              {
                ...
                "answer": "Determining if a machine can exhibit human-like intelligence"
              }
            ]
          },
          {
            ...
            "questions": [
              {
                "question": "What is the main advantage of using 'Cloud Service Providers' like AWS, Azure, and GCP?",
                "options": [
                  "Optimizing frontend performance",
              ...
              {
                "question": "In cloud computing, what does 'Virtualization' refer to?",
                "options": [
              ...
              {
                "question": "What is the primary purpose of 'Containers' in cloud computing?",
                "options": [
              ...
              {
                "question": "What is the role of 'Cloud Storage' in cloud computing?",
                "options": [
                  "Optimizing frontend rendering",
              ...
              {
                "question": "What does 'Security and Compliance' involve in cloud computing?",
                "options": [
                  "Enhancing user interface design",
                  "Ensuring consistent code deployment",
                ...
                "answer": "Implementing measures to protect data and meet regulatory requirements"
              },
              {
              ...
              {
                "question": "What is the main benefit of using 'Serverless Computing'?",
                "options": [
              ...
              {
                "question": "What is the concept of 'Infrastructure as Code' (IaC) in cloud computing?",
                "options": [
                  "Storing and managing server configurations as code",
                  "Creating dynamic UI components",
                  "Storing user interface assets as code",
              ...
              {
                "question": "What does 'Network Virtualization' involve in cloud computing?",
                "options": [
                  "Creating virtual user interfaces",
                  "Simulating human behavior",
